...
public class UsuarioService implements UserDetailsService{
	...
	private static final Logger log = (Logger) org.slf4j.LoggerFactory.getLogger(UsuarioService.class);
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		return new User(usuario.getNombreUsuario(), usuario.getPassword(), usuario.getHablitado(), true, true, true, authorities);
	}
